Shader "Shader Graphs/Water"
{
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 _Multiply_SecondFoam = _SecondFoamColorValue * _SecondFoamMask;

            float4 _Add_9abd66c4b7d74619826f9fdab9a89147_Out_2_Vector4;
            float4 _Add_WithSecondFoam = _Add_243f43a18e694b9e967c04992cecb7b3_Out_2_Vector4 + _Multiply_SecondFoam;
