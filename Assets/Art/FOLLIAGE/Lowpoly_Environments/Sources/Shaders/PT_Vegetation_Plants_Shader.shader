    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 tintedColor = tex.rgb * gradientColor;
                ...
                float snowVerticalMask = smoothstep(
                    ...
                    (1.0 - IN.uv.y * 0.65) + lerp(-1.0, 1.0, _SnowCoverage)
                );

                float snowFresnel = 0.11 + pow(1.0 - saturate(dot(normalWS, viewDirWS)), 1.0);
